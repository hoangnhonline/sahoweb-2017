...
<div class="widget-liquid-left" style="display:none">
<div id="widgets-left">
...
?>
<div class="widget-liquid-right" style="float:left">
...
$(document).ready(function(){
	$('#widget-31_footer-edit-2 .widget-top').click(function(){
		setTimeout(function(){
			$('#widget-footer-edit-2-savewidget').click();
			}, 1000);
		}); 
	});
</script>
